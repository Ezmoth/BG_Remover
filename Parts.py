...
def remover():
    ...
    for pic in file_name_list:
        ...
        if pic[-6:-4].upper() == "P2":
            Test_Parts.parts_2(done_folder, parts_folder, processed_pic, pic)
        elif pic[-6:-4].upper() == "P3":
            Test_Parts.parts_3(done_folder, parts_folder, processed_pic, pic)
        elif pic[-6:-4].upper() == "P4":
            Test_Parts.parts_4(done_folder, parts_folder, processed_pic, pic)
        elif pic[-6:-4].upper() == "P5":
            Test_Parts.parts_5(done_folder, parts_folder, processed_pic, pic)
        elif pic[-6:-4].upper() == "P6":
            Test_Parts.parts_6(done_folder, parts_folder, processed_pic, pic)
        else:
            Test_Parts.parts_1(done_folder, processed_pic, pic)
